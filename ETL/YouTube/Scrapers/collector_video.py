...
def collector_video(video_id:str):
    ...
    for item in response['items']:
        ...
        like_counts.append(item['statistics']['likeCount'] if 'likeCount' in item['statistics'] else 0)
        comment_counts.append(item['statistics']['commentCount'] if 'commentCount' in item['statistics'] else 0)
